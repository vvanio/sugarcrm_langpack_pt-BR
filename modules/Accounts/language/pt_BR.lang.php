...
$mod_strings = array (
	...
	'ERR_DELETE_RECORD' => 'Você deve especificar um número de registro para excluir esta Conta.',
	...
	'MSG_DUPLICATE' => 'O registro de Conta que você está para criar pode ser uma duplicação de outro registro existente. Um registro de conta com um nome similar já existe.<br>Clique Criar Conta para continuar criando esta nova conta, ou selecione um registro existente listado abaixo.',
	'MSG_SHOW_DUPLICATES' => 'O registro de Conta que você está para criar pode ser uma duplicação de outro registro existente. Registros de Contas com nomes similares estão listados abaixo.<br>Clique Salvar para continuar criando esta nova conta, ou clique Cancelar para retornar ao módulo sem criar a conta.',
	...
	'NTC_REMOVE_ACCOUNT_CONFIRMATION' => 'Você está certo que quer remover este registro?',
	'NTC_REMOVE_MEMBER_ORG_CONFIRMATION' => 'Você está certo que quer remover este registro como uma organização membro?',
	...
	'LBL_CAMPAIGN_ID' => 'Campanha ID',
	'LBL_PARENT_ID' => 'Origem ID',
